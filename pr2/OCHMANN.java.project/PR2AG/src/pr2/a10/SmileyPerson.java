...
public class SmileyPerson extends SmileyModel{
	...
	public SmileyPerson (Point2D position, double radiusHead, boolean smile, String lastname, String firstname, int year) {
	...
	public SmileyPerson (SmileyPerson person) {
		this(person.getPosition(), person.getRadiusHead(), person.getSmile(),  person.getLastname(), person.getFirstname(), person.getYear());
	}
